...
const Portfolio = () => {
  return (
    <div classNameName=" container xl:px-8 xl:py-10 pb-20">
      <div classNameName="flex">
        <div classNameName="mx-4 w-full">
          <div classNameName="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
            <span classNameName="mb-2 block text-lg font-semibold text-primary">
              Portfolio
            </span>
            <h2 classNameName="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">
              Our Designs
            </h2>
            <p classNameName="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
